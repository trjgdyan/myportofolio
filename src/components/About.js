  ...
  return (
    <section className="section__container about__container" id="about">
      <div className="about__image">
        <img src="assets/bg.png" alt="bg" className="about__bg-1" />
        <img src="assets/bg.png" alt="bg" className="about__bg-2" />
        <img src="assets/coba1.jpeg" alt="about" className="about__img" />
      </div>
      <div className="about__content">
        <h2 className="section__header">About Me</h2>
        <p className="section__description">
          I'm a proactive informatics engineering student at the State
          Polytechnic of Malang, passionate about website development, mobile
          development, UI/UX design and data processing. I'm a self-motivated
